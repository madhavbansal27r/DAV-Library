...
<body>
  ...
  <div class="vertical-nav bg-white" id="sidebar">
    ...
    <ul class="nav flex-column bg-white mb-0">
      ...
      <li class="nav-item">
        <a href="issue report form.php" class="nav-link active text-dark bg-light">
  ...
  <div class="page-content p-5 table " id="content" style="color: white;">
    <?php
    include("data_class.php");
    $u = new data;
    $u->setconnection();
    $u->issuedata();
    $recordset = $u->issuedata();
    $table = "<table>
  <tr>
  <th>ISSUE ID</th>  
  <th>USER ID</th>
  ...
  <th>FINE</th>
    ...
    foreach ($recordset as $row) {  //this means that every recored represent in the form of the rows
      $table .= "<tr>";
      $table .= "<td>$row[0]</td>";
      $table .= "<td>$row[1]</td>";    // this is for the image
      $table .= "<td>$row[2]</td>";
