...
<body>
  ...
  <div class="vertical-nav bg-white" id="sidebar">
    ...
    <ul class="nav flex-column bg-white mb-0">
      ...
      <li class="nav-item">
        <a href="issue book form.php" class="nav-link active text-dark bg-light">
  ...
  <div class="page-content p-5" id="content">
    ...
    <form action="issuebook_server_page.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="row mb-1">
        <label class="col-sm-2 col-form-label">Choose Book</label>
        <div class="col-sm-3">
          <!-- <input type="email" class="form-control" id=""> -->
          <select class="form-select" class="form-control" name="selectbook" aria-label="Default select example">
      ...
      <div class="row mb-1">
        ...
        <div class="col-sm-3">
          <!-- <input type="email" class="form-control" id=""> -->
          <select class="form-select" class="form-control" name="selectuser" aria-label="Default select example">
            <!-- <option selected>Open this select menu</option> -->
            <?php
            // include("data_class.php");
            $u = new data;
      ...
      <div class="row mb-4">
        <label class="col-sm-2 col-form-label">Select Days</label>
        <div class="col-sm-3">
          <input type="number" name="selectdays" class="form-control" id="">
          <!-- <select class="form-select" class="form-control" name="selectdays" aria-label="Default select example"> -->
          <!-- <option selected>Open this select menu</option> -->
          </select>
        </div>
      </div>
