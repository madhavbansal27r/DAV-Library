...
<div class="vertical-nav bg-white" id="sidebar">
  ...
  <p  class="text-black font-weight-bold text-uppercase px-4 small pb-3 mb-1">Dashboard</p> </a>
  ...
  <ul class="nav flex-column bg-white mb-0">
    ...
    <li class="nav-item">
      <a href="add books form.php" class="nav-link active text-dark bg-light">
    ...
    <li class="nav-item">
      <a href="book request form.php" class="nav-link text-dark">
        ...
        <fieldset class="row mb-5">
          ...
          <div class="col-sm-10">
            <div class="form-check">
              <input class="form-check-input" type="radio" name="branch" id="gridRadios1" value="BSIT" >
              <label class="form-check-label" for="gridRadios1">
                BSIT
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="branch" id="gridRadios2" value="BSCS">
              <label class="form-check-label" for="gridRadios2">
                BSCS
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="branch" id="gridRadios2" value="BSSE">
              <label class="form-check-label" for="gridRadios2">
                BSSE
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="branch" id="gridRadios2" value="Other">
              <label class="form-check-label" for="gridRadios2">
                Other
              </label>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-5">
                    <input type="file" name="bookphoto" class="form-control" id="">
                  </div>
